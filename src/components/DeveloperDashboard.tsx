...
export function DeveloperDashboard() {
  ...
  return (
    <section id="developer-dashboard" className="py-16 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            <TypedText 
              text="Real-time performance metrics and analytics for YassinIPTV platform." 
              delay={1000}
              typingSpeed={20}
            />
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <GlassCard className="p-4" glowOnHover neonColor="blue">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-yassin-neon-blue">{performanceData.loadTime.toFixed(2)}s</p>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-4" glowOnHover neonColor="purple">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-yassin-neon-purple">{performanceData.fps}</p>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-4" glowOnHover neonColor="green">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-yassin-neon-green">{performanceData.memoryUsage}%</p>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-4" glowOnHover neonColor="pink">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-yassin-neon-pink">{performanceData.cpuUsage}%</p>
            </div>
          </GlassCard>
        </div>
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 left-10 w-32 h-32 bg-yassin-neon-blue/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 right-10 w-40 h-40 bg-yassin-neon-green/10 rounded-full blur-3xl"></div>
    </section>
  );
}

...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="mb-6 inline-block">
              <div className="flex items-center justify-center lg:justify-start mb-4">
                ...
                <div className="relative h-20 w-auto">
                  <div className="absolute inset-0 blur-lg bg-gradient-to-r from-yassin-neon-blue via-yassin-neon-purple to-yassin-neon-pink rounded-full opacity-60"></div>
                  <div className="relative flex items-center justify-center h-full">
                    <span className="text-4xl md:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-yassin-neon-blue via-white to-yassin-neon-pink drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]">
                      YASSIN
                    </span>
                    <span className="text-xl md:text-2xl font-bold text-white ml-2 bg-gradient-to-r from-yassin-neon-blue to-yassin-neon-pink px-2 py-1 rounded">
                      IPTV
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <span className="block bg-gradient-to-r from-yassin-neon-blue via-white to-yassin-neon-pink text-transparent bg-clip-text">
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="text-lg font-semibold px-8 py-6 border-2 border-yassin-neon-blue hover:bg-yassin-neon-blue/20 text-white rounded-full transition-all duration-300"
          ...
          <div className={`relative ${isScrolled ? 'visible' : ''} fade-in-up hidden lg:block`}>
            <div className="absolute inset-0 rounded-3xl blur-2xl bg-gradient-to-r from-yassin-neon-blue via-yassin-neon-purple to-yassin-neon-pink opacity-30"></div>
            <div className="relative aspect-video bg-gradient-to-br from-[#0f0f18] to-[#1a1a2e] rounded-2xl border border-white/10 overflow-hidden flex items-center justify-center p-2">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-full h-full relative">
                  ...
                  <div className="absolute top-1/4 left-1/3 w-2 h-2 rounded-full bg-yassin-neon-blue animate-pulse-glow"></div>
                  <div className="absolute top-1/3 left-2/3 w-2 h-2 rounded-full bg-yassin-neon-pink animate-pulse-glow" style={{animationDelay: '0.5s'}}></div>
                  <div className="absolute top-2/3 left-1/2 w-2 h-2 rounded-full bg-yassin-neon-blue animate-pulse-glow" style={{animationDelay: '1s'}}></div>
                  <div className="absolute top-1/2 left-1/4 w-2 h-2 rounded-full bg-yassin-neon-pink animate-pulse-glow" style={{animationDelay: '1.5s'}}></div>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                <div className="bg-black/60 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/10">
                  <span className="text-xs text-yassin-neon-blue">4K</span>
                  <span className="text-xs text-white ml-1">Ultra HD</span>
                </div>
                <div className="bg-black/60 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/10">
                  <span className="text-xs text-yassin-neon-pink">LIVE</span>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -right-10 bottom-10 w-20 h-40 bg-gradient-to-br from-[#0f0f18] to-[#1a1a2e] rounded-xl border border-white/10 transform rotate-12 shadow-lg">
              <div className="absolute top-3 left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-yassin-neon-blue"></div>
              ...
              <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 grid grid-cols-2 gap-2">
                <div className="w-3 h-3 rounded-sm bg-yassin-neon-pink"></div>
                <div className="w-3 h-3 rounded-sm bg-yassin-neon-blue"></div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-bounce">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-yassin-neon-blue">
      ...
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-yassin-neon-blue/10 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-yassin-neon-pink/10 rounded-full blur-3xl"></div>
    </section>
  );
};

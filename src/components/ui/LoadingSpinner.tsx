...
const LoadingSpinner = ({ 
  ...
  const variantClasses = {
    ...
    primary: "border-t-yassin-neon-purple border-r-yassin-neon-purple/20 border-b-yassin-neon-purple/30 border-l-yassin-neon-purple/50",
    secondary: "border-t-yassin-neon-pink border-r-yassin-neon-pink/20 border-b-yassin-neon-pink/30 border-l-yassin-neon-pink/50"
  };

...
export function InstallGuide() {
  ...
  return (
    <section id="install" className="py-20 bg-gradient-to-b from-yassin-darkest to-yassin-dark">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto">
            Set up YassinIPTV on your preferred device in just a few simple steps
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <GlassCard className="p-8">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-6">
              <div className="bg-yassin-neon-blue/20 p-6 rounded-full">
                <selectedPlatform.icon className="w-16 h-16 text-yassin-neon-blue" />
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-2">
                  Setting up YassinIPTV on {selectedPlatform.name}
                </h3>
                <p className="text-white/70">
                  Follow these simple steps to get started with YassinIPTV on your {selectedPlatform.name} device.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {selectedPlatform.steps.map((step, index) => (
                <div key={index} className="flex gap-4">
                  <div className="bg-yassin-neon-blue/20 h-8 w-8 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-yassin-neon-blue font-medium">{index + 1}</span>
                  </div>
                  <div className="pt-1">
                    <p>{step}</p>
                  </div>
            ...
            <div className="mt-8 p-4 bg-white/5 rounded-lg">
              ...
              <div className="mt-4">
                <a
                  href="https://wa.me/212657263966?text=I need help setting up YassinIPTV on my device"
                  target="_blank"
        ...
        <div id="reseller" className="mt-16 max-w-3xl mx-auto">
          <GlassCard className="p-8 text-center border border-yassin-neon-green/30">

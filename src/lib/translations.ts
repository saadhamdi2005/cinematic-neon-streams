...
export const enTranslations: Record<TranslationKey, string> = {
  ...
  login: "Login",
  sign_up: "Sign Up",
  copyright: "© 2023 Yassin IPTV. All rights reserved.",
  try_our_iptv: "Try Our IPTV Service",
  try_now: "Try Now",
  welcome: "Welcome to Yassin IPTV",
  ...
  chat_welcome: "Welcome to Yassin IPTV support!",
...
export const frTranslations: Record<TranslationKey, string> = {
  ...
  login: "Connexion",
  sign_up: "S'inscrire",
  copyright: "© 2023 Yassin IPTV. Tous droits réservés.",
  try_our_iptv: "Essayez Notre Service IPTV",
  try_now: "Essayer Maintenant",
  welcome: "Bienvenue chez Yassin IPTV",
  ...
  chat_welcome: "Bienvenue au support Yassin IPTV !",
...
export const arTranslations: Record<TranslationKey, string> = {
  ...
  login: "تسجيل الدخول",
  sign_up: "إنشاء حساب",
  copyright: "© 2023 Yassin IPTV. جميع الحقوق محفوظة.",
  try_our_iptv: "جرب خدمة IPTV لدينا",
  try_now: "جرب الآن",
  welcome: "مرحباً بكم في Yassin IPTV",
  ...
  chat_welcome: "مرحبًا بك في دعم Yassin IPTV !",
...
export const esTranslations: Record<TranslationKey, string> = {
  ...
  sign_up: "Registrarse",
  copyright: "© 2023 Yassin IPTV. Todos los derechos reservados.",
  try_our_iptv: "Pruebe nuestro servicio IPTV",
  try_now: "Probar ahora",
  welcome: "Bienvenido a Yassin IPTV",
  ...
  chat_welcome: "¡Bienvenido al soporte de Yassin IPTV!",
